...
if "%FLUTTER_SDK%"=="" (
  powershell -NoProfile -ExecutionPolicy Bypass -File "%REPO_DIR%\tools\eco_compile_windows.ps1" -InstallCodegen -CreateExeInstaller
) else (
  powershell -NoProfile -ExecutionPolicy Bypass -File "%REPO_DIR%\tools\eco_compile_windows.ps1" -FlutterSdkPath "%FLUTTER_SDK%" -InstallCodegen -CreateExeInstaller
)
